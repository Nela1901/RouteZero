...
erDiagram
    ...
    RUTA_PEDIDOS {
        UUID ruta_pedido_id PK
        UUID ruta_id FK
        UUID pedido_id FK
        INTEGER orden_entrega
        TIME hora_estimada
    ...
    METRICAS_SOSTENIBILIDAD {
        UUID metrica_id PK
        UUID ruta_id FK
        DECIMAL emision_co2_kg
        DECIMAL combustible_ahorrado_l
        DECIMAL distancia_optimizada_km
        DECIMAL cumplimiento_ventanas_pct
        DECIMAL ahorro_soles
    }
    ...
    CONDUCTORES ||--o{ RUTAS : "opera"
    VEHICULOS ||--o{ RUTAS : "asignado a"
    CLIENTES ||--o{ PEDIDOS : "registra"
    RUTAS ||--o{ RUTA_PEDIDOS : "agrupa"
    PEDIDOS ||--o{ RUTA_PEDIDOS : "incluido en"
    RUTAS ||--|| METRICAS_SOSTENIBILIDAD : "genera"
